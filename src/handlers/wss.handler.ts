...
handler[`${CONSTANTS.SOCKET.EVENTS.REQUEST.PLAY_GAME}`] = async (data: any, wss: WebSocket.Server<WebSocket.WebSocket>, ws: WebSocket.WebSocket, eventName: string) => await playGame(data, wss, ws, eventName)
